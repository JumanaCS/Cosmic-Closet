...
Cosmic Closet is a **social e-commerce platform** for buying and selling used, vintage, and repurposed items. What makes it unique is the ability for users to create and share outfits from the items they're selling, blending fashion inspiration with sustainable shopping.
...
- **Fast Fashion Waste** — Millions of garments end up in landfills yearly
- **Fragmented Resale Market** — Existing platforms lack community and creativity
- **No Outfit Inspiration** — Buyers struggle to visualize how items work together
- **Limited Social Features** — Resale apps feel transactional, not personal

### The Solution

Cosmic Closet addresses these challenges by providing:
- **Outfit Creation Tools** — Sellers can style and showcase items together
- **Social Commerce** — Follow sellers, like outfits, build community
- **Sustainable Shopping** — Give pre-loved items a second life
- **Visual Discovery** — Browse by outfit, not just individual items
...
### Nav Bar
<div>
<img width="720" src="Readme Slides/vid.gif">
</div>
...
Cosmic Closet was submitted to the local UNO Startup competition. Our journey:

| Stage | Achievement |
|-------|-------------|
| **Application** | Selected as 1 of 8 teams from nearly 40 applications |
| **Seminars** | Attended mentorship sessions and workshops |
| **Finals** | Chosen as 1 of 5 teams to pitch at the final competition |
| **Award** | Won the **Social Innovation Award** |

![706a30b3-be51-4e52-84c5-b9fa8b368c89](https://github.com/user-attachments/assets/64b822fa-6af5-4248-96c9-3d9766b6699f)
...
<img width="1440" alt="Screenshot 2025-01-12 at 4 24 08 AM" src="https://github.com/user-attachments/assets/aa2a61a5-7837-4ea3-b218-56a6bff9bbbb" />
<img width="1440" src = "Readme Slides/vid1.gif">
<img width="1440" alt="Screenshot 2025-01-12 at 4 31 23 AM" src="https://github.com/user-attachments/assets/7e989ffc-5233-4795-80c1-0f55eb5a3574" />
